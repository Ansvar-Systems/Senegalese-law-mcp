 ...
 * from jo.gouv.sn (Akoma Ntoso HTML).
 *
 * Features:
 ...
 *
 * Data source: jo.gouv.sn (National Council for Law Reporting)
...
async function main(): Promise<void> {
  ...
  console.log('====================================================\n');
  console.log(`  Source: jo.gouv.sn (National Council for Law Reporting)`);
  ...
  for (const law of acts) {
    ...
    try {
      ...
      const parsed = parseSenegalLawHtml(html, act);
  ...
  console.log(`\n  Source:      jo.gouv.sn (Akoma Ntoso HTML)`);
